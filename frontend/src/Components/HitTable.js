...
import MemoryData from "./hit_miss.json";
      ...
      if(index > 300*(next+1)) return
       return(
           <tr>
                ...
                <td onMouseEnter={() => handleMouseEnter(index,1)} onMouseLeave={() => handleMouseLeave(1)} style={{width:'20%', textAlign:'center', backgroundColor : hoverdIndex == index && value1 ? "#DCCAE9" : "white" }}>{data['Fetch']}</td>
                <td onMouseEnter={() => handleMouseEnter(index,2)} onMouseLeave={() => handleMouseLeave(2)} style={{width:'20%', textAlign:'center', backgroundColor : hoverdIndex == index && value2 ? "#DCCAE9" : "white"}}>{data['Memory']}</td>
